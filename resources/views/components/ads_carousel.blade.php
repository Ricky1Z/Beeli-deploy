<div id="default-carousel" class="relative w-full px-12 mt-20 md:mt-10 lg:mt-16 xl:mt-20" data-carousel="slide">
    <!-- Carousel wrapper -->
    <div class="relative h-56 overflow-hidden md:h-96  rounded-3xl">
        ...
        <!-- Item 1 -->
            ...
            <div class="flex gap-4 w-full" data-carousel-item>
                ...
                <div class="relative w-full md:w-1/2 rounded-3xl hidden md:flex justify-center items-center">
                    <img src="{{ asset('img/ads/ads3.png') }}" alt="" class="w-full h-auto object-cover rounded-3xl">
                </div>
            </div>
            <!-- Item 3 -->
            <div class="flex gap-4 w-full" data-carousel-item>
    ...
    <div class="absolute z-30 flex -translate-x-1/2 bottom-5 left-1/2 space-x-3 rtl:space-x-reverse">
        ...
        <button type="button" class="w-3 h-3 rounded-full border-2 border-accent hover:bg-accent-hover bg-accent" aria-current="false" aria-label="Slide 2" data-carousel-slide-to="1"></button>
        <button type="button" class="w-3 h-3 rounded-full border-2 border-accent hover:bg-accent-hover bg-accent" aria-current="false" aria-label="Slide 3" data-carousel-slide-to="2"></button>
    </div>
    <!-- Slider controls -->
